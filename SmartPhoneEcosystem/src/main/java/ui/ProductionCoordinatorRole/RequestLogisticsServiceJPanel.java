...
public class RequestLogisticsServiceJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestLogisticsServiceJPanel(JPanel userProcessContainer, UserAccount account, SmartphoneProductCatalog smartphoneProductCatalog, Enterprise enterprise, EcoSystem ecosystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Send Request Logistics Service");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel10, javax.swing.GroupLayout.DEFAULT_SIZE, 405, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestActionPerformed
        ...
        TransportationWorkRequest request = new TransportationWorkRequest();
        ...
        for(Network network : system.getNetworkList()){
            for(Enterprise e : network.getEnterpriseDirectory().getEnterpriseList()){
                for (Organization organization : e.getOrganizationDirectory().getOrganizationList()){
                    if (organization instanceof DistributionTransportationOrganization){
                        org = organization;
                        break;
                    }
                }
